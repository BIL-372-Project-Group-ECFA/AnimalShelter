...
import "./ShelterSelectionVet.css"; // CSS dosyasını dahil et

const ShelterSelectionVet = () => {
  ...
  const handleShelterSelection = (shelter) => {
    ...
    navigate("/veterinarian-dashboard"); // Yönetici ekranına yönlendir
  };
...
export default ShelterSelectionVet;
